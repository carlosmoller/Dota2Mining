...
import funcionalidades.sugerirTempo;
 ...
 * @author calmeida
 */
public class tempoIdeal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Match Duration Suggestion Tool");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        sugerirTempo previsao = new sugerirTempo(picks[0],
                                                 picks[1],
                                                 picks[2],
                                                 picks[3],
                                                 picks[4],
        ...
        for (int i = 0; i < 4; i++) {
             if (previsao.eval.predictions().get(i).predicted() == 0) {
                 tabela.insertRow(tabela.getRowCount(), new Object[]{(String) ""+tempo*(i+1)+" Minutes",(String) "Victory"}); 
             }
             else {
                 tabela.insertRow(tabela.getRowCount(), new Object[]{(String) ""+tempo*(i+1)+" Minutes",(String) "Defeat"}); 
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tempoIdeal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tempoIdeal().setVisible(true);
            }
        });
    }
